...
Демо-версия игры антиквест (только две локации) Cобрать и запустить в консоли через compile_and_run.bat. Затем можно открывать test_comments.gam в классическом плеере.
